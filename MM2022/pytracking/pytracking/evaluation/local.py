...
def local_env_settings():
    ...
    settings.lasot_path = ''
    settings.network_path = '/home/MM2022/pytracking/pytracking/networks/'    # Where tracking networks are stored.
    settings.nfs_path = ''
    settings.otb_path = ''
    settings.oxuva_path = ''
    settings.result_plot_path = '/home/MM2022/pytracking/pytracking/result_plots/'
    settings.results_path = '/home/dataset/NIPS2022_workspace/GOT10K-C/firstframe-corrupt/'    # Where to store tracking results
    settings.segmentation_path = '/home/MM2022/pytracking/pytracking/segmentation_results/'
