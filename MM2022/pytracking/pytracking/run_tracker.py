...
def run_tracker(tracker_name, tracker_param, run_id=None, dataset_name='otb', sequence=None, debug=0, threads=0,
                visdom_info=None,result_name = 'dimp', blend=0,visual=0, corrupt=0 ):
...
def main():
    ...
    run_tracker(args.tracker_name, args.tracker_param, args.runid, args.dataset_name, seq_name, args.debug,
                args.threads, {'use_visdom': args.use_visdom, 'server': args.visdom_server, 'port': args.visdom_port}, result_name = args.result_name, blend=args.blend, visual=args.visual, corrupt=args.corrupt)
