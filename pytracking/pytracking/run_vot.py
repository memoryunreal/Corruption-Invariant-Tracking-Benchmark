...
def run_vot2020(tracker_name, tracker_param, run_id=None, debug=0, visdom_info=None, random_corrupt=0):
    tracker = Tracker(tracker_name, tracker_param, run_id)
    tracker.run_vot2020(debug, visdom_info, random_corrupt=random_corrupt)
