...
def run_vot_exp(base_tracker, base_param, ref_tracker, ref_param, use_new_box, save_dir, vis=False, depthth=0, blend=0.0, style="JET"):
# def run_vot_exp(base_tracker, base_param, ref_tracker, ref_param, use_new_box):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--depthvalue", default=0, type=int)
    parser.add_argument("--blend", default=0, type=float)
    ...
    run_vot_exp(base_tracker='stark_st', base_param='baseline_deit', ref_tracker="stark_ref", ref_param="baseline",
                use_new_box=False, save_dir=save_dir, vis=False, depthth=args.depthvalue, blend=args.blend,style=args.colormap)
    # run_vot_exp(base_tracker='stark_st', base_param='baseline_deit', ref_tracker="stark_ref", ref_param="baseline",
    #             use_new_box=False)