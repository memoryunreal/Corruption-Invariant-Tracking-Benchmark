...
class LaSOTlmdbDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        if self.split == "train":
            dataset_name = "lasot_train_lmdb"
        elif self.split == "test":
            dataset_name = "lasot_lmdb"
        else:
    ...
    def _get_sequence_list(self):
        if self.split == "train":
            train_dir = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', '..', 'train')
            file_path = os.path.join(train_dir, 'data_specs', 'lasot_train_split.txt')
