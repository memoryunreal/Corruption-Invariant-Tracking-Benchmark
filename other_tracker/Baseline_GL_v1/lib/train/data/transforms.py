...
class TrackMix(TransformBase):
    ...
    def transform_image(self, img):
        ...
        # ori_img = img.numpy()
        # cv.imwrite('/home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/other_tracker/Baseline_GL_v1/debug/ori_img.png', np.transpose(ori_img, (1,2,0))*255)
                    ...
                    img[:, x1:x1 + h,
                        y1:y1 + w] = (1 - m) * img[:, x1:x1 + h, y1:y1 +
                                                   w] + m * self.supImage[:, x2:x2 + h,
                                                                y2:y2 + w]
                # cv.imwrite('/home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/other_tracker/Baseline_GL_v1/debug/sup_img.png', np.transpose(sup_img, (1,2,0))*255)
                # cv.imwrite('/home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/other_tracker/Baseline_GL_v1/debug/mix_img.png', np.transpose(img.numpy(), (1,2,0))*255)
                return img
        return img