...
'''
asynchronize_workspace = '/ssd3/lz/TMM2022/workspace/asynchronize/'
asynchronize_list = ['asynchronize5','asynchronize10']
# trackers = ['DAL']
trackers = ['CSRRGBD++','DSKCF_shape', 'DAL', 'TSDM', 'DeT','DRefine']
...
for syn in asynchronize_list:
        ...
        for id, tracker in enumerate(all_trackers):
            ...
            print('Trackers: {} syn: {} seq: {} pr: {} re: {} fscore: {}'.format(tracker.name, syn, tracker_seq_number, pr, re, fscore))
...
for i, sre in enumerate(syn_average_fscore):
    ...
    print('Trackers: {} asyn pr:{} re: {} fscore: {}'.format(trackerID, srepr, srere, srefscore))

    logging.info('Trackers: {} asyn pr:{} re: {} fscore: {}'.format(trackerID, srepr, srere, srefscore))
