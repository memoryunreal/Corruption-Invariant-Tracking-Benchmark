...
# trackers_list = ['CMCT', 'DAL', 'DeT', 'keeptrack_fast_origin', 'dimp_origin', 'atom_origin', 'TSDM']
trackers_list = ['ATCAIS20', "CADMS","CSR-depth","DDiMP","iiau_rgbd","OTR","SiamM_Ds","sttc_rgbd","TSDM","DAL","DRefine","LTDSEd","SiamDW_D","SLMD","TALGD"]
all_trackers = [Tracking(tracker, path="/ssd3/lz/TMM2022/workspace/speed/results") for tracker in trackers_list]
