...
for i in ${!array[*]};
do
python /home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/pytracking/pytracking/run_tracker.py ${array[$i]} ${array2[$i]} --dataset_name got10k_val --gpuid 7 --threads 4 --result_name /home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/workspace/GOT-10K/results/${array[$i]}_${array2[$i]} --corp_dataset 0 --datasetpath /home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/workspace/GOT-10K/val/
echo $i got10k finished!!!!!!!!!!!!!!!!!!!!!!!
done
