...
for i in mixformer mixformer
do
CUDA_VISIBLE_DEVICES=4 /opt/conda/envs/pytracking/bin/vot evaluate --workspace /home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/workspace/vot2020-C $i
echo $i vot2020-C finished!!!!!!!!!!!!!!!!!!!!!!!
done
