...
for i in ${!array[*]};
do
python /home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/pytracking/pytracking/run_tracker.py ${array[$i]} ${array2[$i]} --dataset_name uav --gpuid 0 --threads 4 --result_name /home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/workspace/UAV123-C/results/${array[$i]}_${array2[$i]} --corp_dataset 0 --datasetpath /home/CVPR2023/Corruption-Invariant-Tracking-Benchmark/workspace/UAV123-C/
echo $i uav123-C finished!!!!!!!!!!!!!!!!!!!!!!!
done
